...
function MentionSuggestions({prefix, mentions, highlightedMentionIndex = 0, onSelect, isMentionPickerLarge, measureParentContainer = () => {}, onClose = () => {}}: MentionSuggestionsProps) {
